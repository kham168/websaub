<template>
    <v-app>
      <v-container fluid class="pa-0">
        ...
        <v-container class="pb-12">
          ...
          <!-- Empty State -->
          <v-row v-else-if="filteredData.length === 0" class="text-center py-16">
            <v-col cols="12">
              <v-icon size="120" color="grey-lighten-2">mdi-taxi</v-icon>
              <h3 class="text-h5 text-grey-darken-1 mt-6">
                ບໍ່ພົບຂໍ້ມູນລົດແທັກຊີ່
              </h3>
              <p class="text-body-1 text-grey mt-2 mb-4">ກະລຸນາລອງຄົ້ນຫາໃໝ່</p>
              <v-btn
                color="primary"
                variant="tonal"
                prepend-icon="mdi-refresh"
          ...
          <v-row v-else>
            ...
            >
              ...
              >
                <!-- Responsive Image using v-img only, no carousel wrapper needed -->
                <v-img
                  :src="
                ...
                >
                  ...
                  <!-- Top overlay: counter + nav arrows -->
                  <div
                    class="d-flex align-center justify-space-between fill-height px-2"
                  >
                    <!-- Prev arrow -->
                    <v-btn
                ...
                <v-card-text class="pa-3 pa-sm-4 flex-grow-1">
                  <!-- Name -->
                  <h4
                    class="text-body-1 text-sm-h6 font-weight-bold mb-2 mb-sm-3 text-primary text-truncate"
                  >
                    {{ taxi.name }}
                  </h4>
                  ...
                  <v-sheet
                    border="s-lg"
                    color="transparent"
                    class="border-success pl-3 mb-2 mb-sm-3"
                  >
                    <v-chip
                      color="success"
                      variant="flat"
                  ...
                  <!-- Contact -->
                  <div
                    class="d-flex align-center ga-2 mb-2 mb-sm-3 cursor-pointer"
                  ...
                  >
                    ...
                    <span
                      class="text-primary font-weight-medium text-caption text-sm-body-2"
                    >
                      {{ taxi.tel }}
                    </span>
                  </div>
            ...
            <v-col cols="12" class="mt-4">
              ...
              <div class="d-flex align-center mb-4">
                ...
                <span class="text-h5">ແນະນຳເບຣນດອື່ນๆ</span>
              </div>
              <v-divider class="mb-4" />
            </v-col>
            ...
            <!-- Top Data Carousel -->
            <!-- <v-col cols="12">
              <v-sheet rounded="lg" color="grey-lighten-3" class="pa-4">
                <v-carousel
                  cycle
                  show-arrows
                  hide-delimiters
        ...
        >
          <v-card rounded="xl" elevation="24">
            ...
            <!-- Carousel -->
            <!-- <v-card-text class="pa-2 pa-sm-4 pa-md-8 bg-grey-lighten-4"> -->
            <v-carousel
              v-model="zoomSlide"
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <!-- Bottom: Play/Pause + Dots indicator -->
                  <div
  ...
  onMounted(async () => {
    ...
    try {
      ...
      const provinceList = Array.isArray(provinceData)
        ? provinceData
        : provinceData.data ?? [];
  ...
  function openWhatsApp(item) {
    ...
    window.open(
      `https://wa.me/856${cleanPhone}?text=${encodeURIComponent(
        "ສະບາຍດີ! ຂ້ອຍຕ້ອງການລົດ"
      )}`,
      "_blank"
    );
  }
  ...
  <style scoped>
  /* Carousel arrow - small transparent style */
