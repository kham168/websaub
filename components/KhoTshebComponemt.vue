<template>
    <div>
      <v-dialog v-model="isDialogOpen" max-width="900">
        <v-card v-if="props.selectedItem" elevation="3" class="slideshow-card mb-16">
              ...
              <v-col>
                <v-row>
                  ...
                  <v-col md="6" class="d-none d-md-block">
                      ...
                      <v-row>
                          ...
                          >
                            <template #prepend-inner>
                              <v-sheet
                                ...
                                @click="decrease"
                              >
                                <v-icon size="small" color="red">mdi-minus</v-icon>
                              </v-sheet>
                            </template>
                        ...
                        <v-col cols="12">
                          <v-card variant="outlined" class="pa-4">
                            <div class="mb-3">
                              <div v-if="props.selectedItem.discount" class="mb-2">
                                <v-chip
                                  size="small"
                                  color="red"
                                  text-color="white"
                              ...
                              <div class="d-flex align-center">
                                ...
                                <span v-if="props.selectedItem.Price2" class="text-subtitle-2 align-self-start text-decoration-line-through text-grey-darken-1 ml-2">
                                  LAK {{ formatPrice(props.selectedItem.Price2) }}
                                </span>
                              </div>
                            </div>
                    ...
                    >
                      <v-toolbar flat>
                        <v-toolbar-title class="text-h6 text-center font-weight-bold">
                          ຂໍ້ມູນລາຍລະອຽດ
                        </v-toolbar-title>
                      ...
                      <v-container>
                        <p class="mb-2">
                          <strong>Brand:</strong>
                          <span class="text-primary ml-2">{{ props.selectedItem?.name || 'No brand' }}</span>
                        </p>
                        <p class="mb-2">
                          <strong>Email:</strong>
                          <span class="text-primary ml-2">{{ props.selectedItem?.email || '-' }}</span>
                        </p>
                        <p class="mb-2">
                          <strong>Tel & WhatsApp:</strong>
                          <span class="text-primary ml-2">{{ props.selectedItem?.tel || '-' }}</span>
                        </p>
                        <div class="description-section mt-4">
                          ...
                          <span>{{ props.selectedItem?.detail || 'No description available' }}</span>
                        </div>
                      </v-container>
                    </v-navigation-drawer>
                  </v-col>
                  ...
                  <v-col cols="12" md="6" class="pa-8">
                    ...
                    <v-sheet
                      ...
                      style="background: linear-gradient(180deg, white 0%, #ffcc80 100%)"
                      rounded="b-lg"
                    >
                      <v-sheet
                        v-for="(img, idx) in props.selectedItem.image"
  ...
  const handleKeydown = (e) => {
    ...
    if (!((e.keyCode >= 48 && e.keyCode <= 57) || (e.keyCode >= 96 && e.keyCode <= 105) || allowed.includes(e.keyCode))) {
      e.preventDefault();
    }
  };
